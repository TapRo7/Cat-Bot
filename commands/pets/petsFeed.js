...
module.exports = async (interaction) => {
    ...
    const foodButtonsFilter = btnInt => {
    ...
    const foodPoured = await waitForButton(petMessage, foodButtonsFilter);
    ...
    const catFed = await waitForButton(petMessage, foodButtonsFilter);
    ...
    const waterPoured = await waitForButton(petMessage, foodButtonsFilter);
    ...
    const catWatered = await waitForButton(petMessage, foodButtonsFilter);
